...
import BasicTextFields, { SelectTextFields } from "../MUI_Coponents/text_box";
...
const Reallocation_Consent = ({Student}) => {
  ...
  const [briefReason, setBriefReason] = useState(""); // Added state for brief reason
    ...
    <div className="w-[750px] h-[850px] bg-white mt-5 font-mono">
      <div className="flex flex-col">
        ...
        <div className="ml-10 mt-5 h-36 w-3/4 rounded-xl bg-gray-200">
          <h6 className="p-5">
            ROOM ALLOCATION :{Student.Allocation ?<p> DONE </p> :<p>NOT DONE</p>} 
            <div className="pt-7">
              <AlertDialogSlide
