...
function footer_Component({Student}) {
    ...
    return (
        <div className="w-[470px] min-h-screen bg-white rounded-tr-[30px] rounded-br-[30px]  mt-5  border-l-2 border-gray-400" >
            <div className = "flex flex-col">
                <div className = "w-[370px] - h-[560px] bg-zinc-200 rounded-[30px] mt-2 ml-12 shadow-xl">
                    <div className ="flex flex-col ">
                    <div className = "font-extrabold font-mono ml-32 mt-3 ">
                            -Student INFO-
                        </div>
                        <div className = " mt-3 border-b-2  border-white"></div>
                    <div className = " mt-5 ml-32 h-36 w-32 border-2 border-gray-300"> </div>
                    ...
                    <div className ="flex flex-col  m-5">
                       <div className = "flex flex-row ml-5">
                            ...
                            {DueStatus ?<h1 className = " ml-3 font-light font-mono"> Yes</h1>: <h1 className = " ml-3 font-light font-mono"> No</h1> }
                            
                        </div>
                    </div>
                </div>
                <div className = "w-[370px] - h-[250px] bg-zinc-200 rounded-[30px] mt-8 ml-12 shadow-xl">
                    <div className ="flex flex-col">
