        ...
        <div className ="min-w-screen min-h-screen  bg-white  items-center">
            <div className ="m-28 min-w-screen  md:flex flex-row min-w-screen min-h-screen ml-10 mr-10 mt-10 mb-10">
                <div className =" flex flex-col items-center rounded-2xl mb-20 md:w-1/2 min-h-screen bg-white rounded-l-2xl shadow-2xl shadow-slate-400">
                      ...
                      <div className ="text-4xl font-bold font-mono mt-28">
                            Login
                        </div> 
                        <div
								class="w-96 mt-28 flex flex-col min-w-0 break-words  mb-6  rounded-xl shadow-2xl">
                                    <div class="flex p-5 lg:pl-10">
									<form id="feedbackForm" action="" method="">
										<div class="w-72 mt-5 ">
											<label class="block uppercase text-gray-700 text-xs font-bold mb-2"
                        for="userName">UserName</label><input type="userName" name="userName" id="userName" class="border-[1px] px-3 py-3 rounded text-sm shadow w-full
                     placeholder-black text-gray-800 outline-none focus:bg-gray-400" placeholder=" "
                         required />
                    </div>	
									</form>
								</div>
								<div class="flex-auto pl-5 lg:pl-10">
									<form id="feedbackForm" action="" method="">
										<div class="w-72  mb-3">
											<label class="block uppercase text-gray-700 text-xs font-bold mb-2"
                        for="Password">PassWord</label><input type="password" name="password" id="password" class="border-[1px] px-3 py-3 rounded text-sm shadow w-full
                     placeholder-black text-gray-800 outline-none focus:bg-gray-400" placeholder=" "
                         required />
                    </div>		
